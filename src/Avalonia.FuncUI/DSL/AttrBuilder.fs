...
type AttrBuilder<'view>() =
    ...
    static member private CreateContent
      ( accessor: Accessor,
        content: ViewContent ) : IAttr<'view> =
    ...
    static member private CreateProperty
      ( accessor: Accessor,
        value: obj,
        comparer: Comparer voption,
        defaultValueFactory ) : IAttr<'view> =
    ...
    static member CreateProperty<'value>
      ( property: AvaloniaProperty<ITemplate<_>>,
        value: 'value,
        comparer: Comparer voption ) : IAttr<'view> =
    ...
    static member private CreateInstanceProperty<'value>
      ( name: string,
        value: 'value,
    ...
    static member CreateContentMultiple
      ( property: AvaloniaProperty,
        multipleContent: IView list ) : IAttr<'view> =
    ...
    static member CreateSubscription<'arg, 'owner when 'owner :> AvaloniaObject>
      ( property: DirectProperty<'owner, 'arg>,
        func: 'arg -> unit,
